...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(1, "Mia Amata");
        myFirstMap.put(2, "Nuova Iorca");
        myFirstMap.put(10, "L'Angiola");
        // 1c. Print the map
        System.out.println(myFirstMap);
        // 1d. Access an element in the map with .get
        System.out.println("Al mio tour mondiale andrò negli USA nella città di " + myFirstMap.get(2));
    ...
    private static void exercise2() {
        ...
        System.out.println(mostExpensiveMenuItemName + " max=" + mostExpensivePrice);
        // Your code
