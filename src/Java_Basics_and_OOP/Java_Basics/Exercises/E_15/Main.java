package Java_Basics_and_OOP.Java_Basics.Exercises.E_15;
...
public class Main {
     ...
     *
     *    Write a while loop; Use the calculation for exchange rate below:
    ...
    private static void exercise2() {
        ...
        while (remainingPoundsToSell>0) {  //E SE VOLESSI VENDERE WHILE (CAMBIO > 1.15)? Non potrei riassegnare il cambio o fermerei il loop.
     ...
     * A1: while - finché l'utente è all'ATM, fai cose.
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2: for each; percorre tutta la lista per ogni elemento.
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3: for i; percorre la lista fino all'elemento n.
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4: do while: leggo prime 100 linee, poi verifico se c'è riga n+1: in caso via altre 100.
     */
}
