package Java_Basics_and_OOP.Java_Basics.Exercises.E_14;
...
public class Main {
    ...
    private static void exercise1() {
        ...
        int sumForA = 0;
        for (Integer itemsAdiTurno : itemsA) {
            sumForA = sumForA + itemsAdiTurno;
            System.out.println(itemsAdiTurno);
        }
        ...
        int sumForB = 0;
        for (int itemsBdiTurno : itemsB) {
            sumForB = sumForB + itemsBdiTurno;
            System.out.println(itemsBdiTurno);
        }
        ...
        for (int i=0; i<itemsA.size(); i++) {
            ...
            System.out.println(itemsA.get(i));
        }
