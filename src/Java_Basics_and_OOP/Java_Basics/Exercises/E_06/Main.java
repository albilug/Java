package Java_Basics_and_OOP.Java_Basics.Exercises.E_06;
...
public class Main {
    ...
    private static void exercise3() {
        ...
        int costPerBurger = 9;
        // Write your code here
        int moneyLeftAfterMaxBurger = totalMoney % costPerBurger;
        System.out.println("Remainder=" + moneyLeftAfterMaxBurger);
    ...
    private static void exercise4Bonus() {
        ...
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue)); //Int arrotondato per eccesso.
        // Replace with your comment 2
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue)); //Int arrotondato per difetto.
        // Replace with your comment 3
        System.out.println(ourValue + " after using round=" + Math.round(ourValue)); //Arrotonda: se >=.5, per eccesso. Se <.5, per difetto.
        // Replace with your comment 4
        System.out.println(ourValue + " after using powerOf with the value of 2=" + Math.pow(ourValue, 2)); //eleva a esponente 2.
        // Replace with your comment 5
        System.out.println(ourValue + " after using powerOf with the value of 3=" + Math.pow(ourValue, 3)); //eleva a esponente 3.
        // Replace with your comment 6
        System.out.println(ourValue + " times random =" + Math.random() * ourValue); //moltiplica ourValue per un numero casuale tra 0 e 1.
    }
}
