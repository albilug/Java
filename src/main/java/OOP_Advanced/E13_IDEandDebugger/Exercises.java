package OOP_Advanced.E13_IDEandDebugger;
...
public class Exercises {
    ...
    /** 1:The following code is supposed to do a factorial of the number five, which looks like this: 5*4*3*2*1 = 120
    ...
    /**2:The following code is supposed to reverse a string
     * Find and fix the error using the debugger    */
    ...
    /** 3:  The following code is supposed to check if a number is positive or negative
    ...
    private static void exercise3() {
        ...
        Assertions.assertFalse(isPositive(0)); //Ma zero è FALSE? Mica è negative
