package Java_Basics_and_OOP.Java_Basics.Exercises.E_05;
...
public class Main {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        double decimale = 0.99;
        decimale *= 2;
        System.out.println(decimale);
        double decimaleMezzi = decimale / 2;
        System.out.println(decimaleMezzi);
        // Write your code here
    }
    ...
    private static void exercise3() {
        ...
        double Celsius;
        double Fahrenheit;
        Celsius = 2; //In Padania fa freddino...
    ...
    private static void playAroundWithModulus() {
        ...
        int value = 331;   // <--- change this value
