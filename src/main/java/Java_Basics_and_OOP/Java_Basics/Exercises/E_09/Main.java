package Java_Basics_and_OOP.Java_Basics.Exercises.E_09;
...
public class Main {
    ...
    private static void exercise2() {
        ...
        boolean isLunchAffordable = remainingMoney >= lunchCost;
        if (isLunchAffordable) {
    ...
    private static void exercise3() {
        ...
        double ourDouble = 1.0;
                /* e se avessi posto questa condizione nell'IF?
        boolean isOurDoubleGreatEnough = ourDouble > 2.5;
        Indicando poi ourDouble++ in else?
        Perché non funziona?
         */
        if (ourDouble > 2.5) {
